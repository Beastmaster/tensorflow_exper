'''
multiply layers for mnist data
...
# weight and basis initialization
...
class Tensorflow_mnist_mul_layer:
    def __init__(self):
        pass
    ...
    def train(self):
        ...
        print("test accuracy %g"%sess.run(accuracy,feed_dict={
            x: self.mnist.test_data, y_: self.mnist.test_label, keep_prob: 1.0}))
